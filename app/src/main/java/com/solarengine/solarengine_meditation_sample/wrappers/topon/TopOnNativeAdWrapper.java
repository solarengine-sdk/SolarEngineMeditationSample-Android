...
/**
 * TopOn Native Ad Wrapper
 * Provides callback interception methods for TopOn Native Ad listeners
 */
public class TopOnNativeAdWrapper {

    /**
     * Build ATAdRevenueListener that intercepts revenue callbacks and forwards them to the user
     * This method returns an ATAdRevenueListener object that can be passed to ATNativeAdView
     *
    ...
    public static com.anythink.core.api.ATAdRevenueListener buildATAdRevenueListener(Context context,
        ...
        LogUtils.i("TopOnNativeAdWrapper.buildATAdRevenueListener() called");

        return new com.anythink.core.api.ATAdRevenueListener() {
            @Override
            public void onAdRevenuePaid(@NonNull ATAdInfo atAdInfo) {
                LogUtils.i("TopOn Native Ad onAdRevenuePaid() callback received");
                
                // 调用SolarEngine埋点上报广告展示事件
                TopOnSolarEngineTracker.trackAdImpression(context, atAdInfo, Native);
